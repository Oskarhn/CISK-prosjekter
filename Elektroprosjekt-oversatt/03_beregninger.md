...
Scriptet `calculations.py` regner fram alle tallene i denne filen. Kjør det (ren Python,
ingen avhengigheter) fra `Elektroprosjekt`-mappen:
...
|---|---|---|---|
| MOSFET (IRF3707) | I_D = 187 A puls (≈ 100 µs); V_DS,max ≈ 110 V (avskjeringsspiss: v_C + V_D1 + i·(R_D1+R_FW)) | I_DM ≈ 250 A pulsert; 30 V | V_DS,max overskrir 30 V-ratingen ved avskjering |
