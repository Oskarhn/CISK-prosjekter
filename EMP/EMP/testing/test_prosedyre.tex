...
\section{Test av testversjon (9 V demonstrator)}
Følg prosedyren i \texttt{test\_version/build\_guide.md} for å verifisere at konseptet fungerer før du går videre til hovedversjonen.

\section{Funksjonstest av lader (hovedversjon)}
\begin{enumerate}
\item Koble fra hovedkondensator og gnistgap.
