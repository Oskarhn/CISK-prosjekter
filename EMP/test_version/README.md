kk# Testversjon – 9 V EMP-demonstrator
...
- **Energi:** ~0.04 J (40 mJ)
- **Toppstrøm:** ~1.5 A (overdempet krets – ingen svingninger)
- **Pulsvarighet:** ~80 µs (enkel puls, rask stigning og eksponentiell nedgang)
...
- 1 × Trykknapp (momentan) – for lading
- 1 × Vippebryter (eller manuell tilkobling) – for utladning
...
3. Koble spolen raskt til kondensatoren (ved å slå på vippebryteren eller berøre ledningene). Kondensatoren utlades gjennom spolen i en **overdempet puls** – strømmen stiger raskt og avtar deretter eksponentielt uten å svinge.
...
## Teori
Se `theory.md` for en forklaring av fysikken, inkludert hvorfor kretsen er overdempet og hvilken pulsform du kan forvente.
